...
<img src="./figs/UW_logo.png" height=200 width=200>
...
renderPlot({
  ...
  par(xpd = TRUE, mfrow = c(2,2), mai = c(0.5, 0.5, 1, 0.5), omi = rep(0,4))
  
  ## radar plot
  radarchart(pdat, axistype = 1, seg = upper/5,
             pcol = "purple4", pfcol = adjustcolor("purple4", alpha = 0.5), plwd = 4, 
